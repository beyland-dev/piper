	...
	return withTests({
		...
		steps: [
			withImplementationPlan({
				planningGoal:
					"Inspect src/, tests/, and README.md, then choose one small high-leverage improvement for the Piper runtime that can be completed safely in a single pass",
			...
			withRiskReview({
				...
				reviewGoal:
					"Review the completed repository change for runtime risk, missing validation, and any maintainer follow-up work",
